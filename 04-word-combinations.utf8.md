...
![(\#fig:bigramtfidf)The 12 bigrams with the highest tf-idf from each Jane Austen novel](04-word-combinations_files/figure-docx/bigramtfidf-1.png)
...
![(\#fig:notwordsplot)The 20 words followed by 'not' that had the greatest contribution to sentiment scores, in either a positive or negative direction](04-word-combinations_files/figure-docx/notwordsplot-1.png)
...
![(\#fig:negatedwords)The most common positive or negative words to follow negations such as 'never', 'no', 'not', and 'without'](04-word-combinations_files/figure-docx/negatedwords-1.png)
...
![(\#fig:bigramgraph)Common bigrams in Pride and Prejudice, showing those that occurred more than 20 times and where neither word was a stop-word](04-word-combinations_files/figure-docx/bigramgraph-1.png)
...
![(\#fig:bigramggraphausten2)Common bigrams in Pride and Prejudice, with some polishing.](04-word-combinations_files/figure-docx/bigramggraphausten2-1.png)
...
![(\#fig:kjvbigrams)Directed graph of common bigrams in the King James Bible, showing those that occurred more than 40 times](04-word-combinations_files/figure-docx/kjvbigrams-1.png)
...
![(\#fig:widyr)The philosophy behind the widyr package, which can perform operations such as counting and correlating on pairs of values in a tidy dataset. The widyr package first 'casts' a tidy dataset into a wide matrix, performs an operation such as a correlation on it, then re-tidies the result.](images/widyr.jpg)
...
![(\#fig:wordcors)Words from Pride and Prejudice that were most correlated with 'elizabeth', 'pounds', 'married', and 'pride'](04-word-combinations_files/figure-docx/wordcors-1.png)
...
![(\#fig:wordcorsnetwork)Pairs of words in Pride and Prejudice that show at least a .15 correlation of appearing within the same 10-line section](04-word-combinations_files/figure-docx/wordcorsnetwork-1.png)
