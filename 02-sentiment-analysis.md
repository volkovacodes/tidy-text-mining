...
<div class="rmdtip">
<p>There are also some domain-specific sentiment lexicons available, constructed to be used with text from a specific content area. Section @ref(financial) explores an analysis using a sentiment lexicon specifically for finance.</p>
</div>
